 ...
 */
export function bind(f, thisArg) {
    var _this = this;
    var args = [];
 ...
 * @deprecated
 */
export function callable(obj, f) {
 ...
 * @param thisArg
 */
export function argSort(arr, compareFn, thisArg) {
 ...
 * @param thisArg
 */
export function argFilter(arr, callbackfn, thisArg) {
    var indices = indexRange(arr.length);
 ...
 * @return {number}
 */
export function uniqueId(domain) {
...
export function flagId(domain, id) {
    if (isNaN(id) || id < 0) {
        return id;
    }
    if (!idCounter.hasOwnProperty(domain)) {
 ...
 * @return {string}
 */
export function uniqueString(domain) {
    if (domain === void 0) { domain = '_default'; }
 ...
 */
export var param = new PropertyHandler(location.search);
/**
 ...
 */
export function resolveIn(milliseconds) {
    if (milliseconds <= 0) {
